...
export class AddMediaListCollaboratorStatus1786912872400 implements MigrationInterface {
  name = 'AddMediaListCollaboratorStatus1786912872400';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "media_list_collaborator" ADD "status" character varying NOT NULL DEFAULT 'pending'`
    );
    await queryRunner.query(
